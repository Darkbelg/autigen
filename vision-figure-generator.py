...
creator = FigureCreator(name="Figure Creator~", llm_config={"config_list": [{"model": "gpt-4o", "temperature": 0.7 ,"api_key": os.environ["OPENAI_API_KEY"], "max_tokens": 4096}]})
...
I want to show both temperature high and low in celsius.
""",
)